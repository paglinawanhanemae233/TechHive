<?php
/**
 * TechHive Edit Product Form
 * Handles editing existing products
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_product'])) {
    ...
    if (empty($productData['name'])) {
        ...
        if ($result['success']) {
            $message = 'Product updated successfully!' . (isset($_FILES['product_image']) && $_FILES['product_image']['error'] === UPLOAD_ERR_OK ? ' Image updated.' : '');
...
<head>
    ...
    <title>Edit Product - TechHive Database Manager</title>
    <style>
        :root {
...
<body>
    <header class="header">
        <div class="header-content">
            <div class="logo">TechHive - Edit Product</div>
            <div class="user-info">
    ...
    <div class="container">
        ...
        <div class="form-card">
            <h1 class="form-title">✏️ Edit Product: <?php echo htmlspecialchars($product['name']); ?></h1>
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="cost_price" name="cost_price" step="0.01" min="0" value="<?php echo $product['cost_price']; ?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="minimum_stock" name="minimum_stock" min="0" value="<?php echo $product['minimum_stock']; ?>">
                    </div>
                </div>

                <div class="form-group">
                    <label for="short_description">Short Description</label>
                    <textarea id="short_description" name="short_description" placeholder="Brief product description..."><?php echo htmlspecialchars($product['short_description']); ?></textarea>
                </div>

                <div class="form-group">
                    <label for="long_description">Long Description</label>
                    <textarea id="long_description" name="long_description" placeholder="Detailed product description..."><?php echo htmlspecialchars($product['long_description']); ?></textarea>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="weight" name="weight" step="0.01" min="0" value="<?php echo $product['weight']; ?>">
                    </div>
                </div>

                <div class="form-group">
                    <label for="meta_description">Meta Description</label>
                    <textarea id="meta_description" name="meta_description" placeholder="SEO description..."><?php echo htmlspecialchars($product['meta_description']); ?></textarea>
                </div>

                <div class="form-group">
                    <label for="dimensions">Dimensions</label>
                    <input type="text" id="dimensions" name="dimensions" placeholder="e.g., 35.8 x 23.5 x 1.9 cm" value="<?php echo htmlspecialchars($product['dimensions']); ?>">
                </div>

                <div class="form-group">
                    <label for="tags">Tags</label>
                    <input type="text" id="tags" name="tags" placeholder="e.g., Dell, Laptop, Windows 11, Core i5" value="<?php echo htmlspecialchars($product['tags']); ?>">
                </div>
